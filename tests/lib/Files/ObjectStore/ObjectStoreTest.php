...
class ObjectStoreTest extends TestCase {
	...
	public function testSaveVersion() {
		$this->impl->expects($this->once())->method('saveVersion')->willReturn(true);
		$this->assertTrue($this->objectStore->saveVersion());
	}
	 ...
	 */
	public function testGetVersionsOfUnknownFile($method) {
